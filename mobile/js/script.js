...
function init()
{
	...
	myAnimation1 = new TimelineLite();
	myAnimation2 = new TimelineLite();
	myAnimation3 = new TimelineLite();
	myAnimation4 = new TimelineLite();
	myAnimation5 = new TimelineLite();
	myAnimation6 = new TimelineLite();
	myAnimation7 = new TimelineLite();


	$(".kaiqi_btn").click(function(){
		mySwiper.swipeNext();
	});
