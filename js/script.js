			...
			zj760.obj.animate({
				...
				$('.ad_wrap2 .wenzi').animate({
					...
					$('.ad_wrap2 .diannao').animate({
						...
						$('.ad_wrap2 .ren1 img').fadeIn(250, function() {
							$('.ad_wrap2 .pao1 img').fadeIn(250, function() {
								$('.ad_wrap2 .pao2 img').fadeIn(250, function() {
									$('.ad_wrap2 .pao3 img').fadeIn(250, function() {
										$('.ad_wrap2 .zhuan img').show(200, function() {
											$('.ad_wrap2 .ren2 img').fadeIn(500, function() {
												$('.ad_wrap2 .deng img').fadeIn(500, function() {
													...
													$('.ad_wrap2 .pao3 img').fadeOut(250, function() {
														$('.ad_wrap2 .pao2 img').fadeOut(250, function() {
...
//.ad_wrap4 .bi{ left: 680px; top: 85px; z-index: 3;}
			...
			zj760.obj.animate({
				...
				$('.ad_wrap7 .wz').animate({
					...
					$('.ad_wrap7 .huojian').animate({
						'bottom': $(window).height()-$(window).height()*0.1 - 34 - 253
					}, 1000, 'easeInQuad', function() {
						zj760.data.timer2 = setInterval(function() {
							if (i % 2 == 0) {
								$('.ad_wrap7 .huojian').animate({
									'bottom': $(window).height()-$(window).height()*0.1 - 34 - 253 + 2
								}, 150, 'easeInQuad');
							} else {
								$('.ad_wrap7 .huojian').animate({
									'bottom': $(window).height() -$(window).height()*0.1- 34 - 253 - 2
	...
	init: function() {
		...
		$('.wrap1,.wrap2,.wrap3,.wrap4,.wrap5,.wrap6,.wrap7').css({'height': $(window).height()*0.8,'padding-top':$(window).height()*0.1,'padding-bottom':$(window).height()*0.1});
		$('.J_prev').css({
